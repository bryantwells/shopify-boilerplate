 ...
 * @param string size - The preformatted size and crop we want to use. Shopify 
 * follows a url format when pulling a specific image size. 
 * 
 * See here for reference: 
 * https://help.shopify.com/en/themes/liquid/filters/url-filters#size-parameters
 * Crop is not required but if using a crop then it needs to be appended to 
 * the size using an underscore. Two word crops are also separated by 
 * an underscore.
 */
